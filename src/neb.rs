...
// [[file:~/Workspace/Programming/gosh/nebrun/neb.note::*imports][imports:1]]
use crate::common::*;
...
// [[file:~/Workspace/Programming/gosh/nebrun/neb.note::*types][types:1]]
type Point3D = [f64; 3];
// types:1 ends here
...
// [[file:~/Workspace/Programming/gosh/nebrun/neb.note::*utils][utils:1]]
...
// [[file:~/Workspace/Programming/gosh/nebrun/neb.note::*original][original:1]]
...
// [[file:~/Workspace/Programming/gosh/nebrun/neb.note::*improved%20tangent][improved tangent:1]]
// Parameters
// ----------
...
// [[file:~/Workspace/Programming/gosh/nebrun/neb.note::*elastic%20band][elastic band:1]]
...
// [[file:~/Workspace/Programming/gosh/nebrun/neb.note::*opt][opt:1]]
impl NEB {
    ...
    pub fn run<T: ChemicalModel>(&mut self, model: &T) -> Result<()> {
        use gosh::apps::optimization::*;
        use gosh::apps::optimization::fire::*;
